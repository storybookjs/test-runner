...
const getJestPlaywrightConfig = (): Config.InitialOptions => {
  ...
  return {
    ...
    globalSetup: '@storybook/test-runner/playwright/dist/global-setup.js',
    globalTeardown: '@storybook/test-runner/playwright/dist/global-teardown.js',
    testEnvironment: '@storybook/test-runner/playwright/dist/custom-environment.js',
    setupFilesAfterEnv: [
      '@storybook/test-runner/playwright/dist/jest-setup.js',
