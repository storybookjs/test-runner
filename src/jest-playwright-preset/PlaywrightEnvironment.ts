...
const getDeviceName = (device: Nullable<ConfigDeviceType>): Nullable<string> => {
  ...
  return class PlaywrightEnvironment extends RootEnv {
    ...
    async setup(): Promise<void> {
      ...
      this.global.jestPlaywright = {
        ...
        resetContext: async (newOptions?: BrowserContextOptions): Promise<void> => {
        ...
        resetBrowser: async (newOptions?: BrowserContextOptions): Promise<void> => {
