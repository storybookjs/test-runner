...
export async function setup(jestConfig: JestConfig.GlobalConfig): Promise<void> {
...
export async function teardown(jestConfig: JestConfig.GlobalConfig): Promise<void> {
